...
<a style="cursor: pointer;" onclick="viewFormChecked()">
    ...
    <form id='formCheckedData'>
        ...
        <table class="table table-bordered">
            <tr>
                ...
                <td>
                    <input id="ngay_kiem_tra" 
                        name="ngay_xac_nhan_hien_thuc" 
            ...
            <tr>
                <td>Kết quả</td>
                <td>
                    <select class="form-control" id="ket_qua_kiem_tra_1"
                        name="ket_qua_kiem_tra_1">
            ...
            <tr>
                ...
                <td>
                    <input id="hinh_thuc_xu_phat_1" 
                        name="hinh_thuc_xu_phat_1" type="text" value="" 
                        class="form-control" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <div id='divTest1' class="divTest w-100"></div>
                </td>
            </tr>
            <tr>
                <td></td>
